...
class ResourcesAndPromptsTest(unittest.TestCase):
    def test_resources_and_prompts(self):
        ...
        self.assertIn("hoi4://docs/user", uris)
        self.assertIn("hoi4://docs/developer", uris)
        self.assertIn("hoi4://docs/pitfalls", uris)
        self.assertIn("hoi4://templates/mcp", uris)
        ...
        user_doc = server._read_resource("hoi4://docs/user")
        self.assertIn("正确范式", user_doc)
        dev_doc = server._read_resource("hoi4://docs/developer")
        ...
        self.assertIn("mcp_workflow", names)
        ...
        p3 = server._get_prompt("mcp_workflow", {"role": "user"})
        self.assertIn("使用者工作流", p3["messages"][0]["content"]["text"])
        p4 = server._get_prompt("mcp_workflow", {"role": "developer"})
        self.assertIn("开发者工作流", p4["messages"][0]["content"]["text"])
