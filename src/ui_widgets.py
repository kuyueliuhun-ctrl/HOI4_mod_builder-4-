"""B0 公共 UI 组件（2026-08-23，docs/整合计划.md B0 首版落地）。
...
BLOCK_CN = {
    ...
    "select_effect": "选择效果",
    "continue_effect": "延续效果",
    "prerequisite": "前置",
    "mutually_exclusive": "互斥",
    "offset": "偏移",
    "relative_position_id": "相对位置",
    "search_filters": "搜索过滤",
    "cancel_if_invalid": "失效取消",
    "bypass": "绕过条件",
    "will_claim_areas": "宣称区域",
    "tooltip": "提示",
    "remove": "移除",
    "not": "非",
    "and": "且",
